...
Let's start by doing something about our two `delay()` function calls. If we wanted to change our delay we'd have to do it twice, and that's more chances to make an unforced error than we want to take. 
